...
flags.DEFINE_integer(
    'batch_size', 8, 'Init Local Batch Size')
flags.DEFINE_float(
...
def main(_):
    ...
    train_client_sampler, heldout_client_sampler, test_client_sampler = (
        ...
        fedjax.client_samplers.UniformGetClientSampler(fd = heldout_fd, num_clients = FLAGS.clients_per_round, seed = FLAGS.random_seed+2), 
    ...
    for round_num in range(1, FLAGS.sim_rounds):
        ...
        if round_num % 1 == 0:
            ...
            heldout_metrics = fedjax.evaluate_model(
                model, 
                server_state.params,
            ...
            print(f'[round {round_num}] heldout_metrics={heldout_metrics}')
