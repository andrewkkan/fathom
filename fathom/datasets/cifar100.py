# The code originated by Google LLC has been slightly
# modified.  Main modification is casting the output sample "x"
# to astype(np.float32) in function prepreocess_client.
...
_FEDJAX_SQLITE_HEXDIGEST = {
    ...
    'train': '3fc4487f3fa5a033a3036bd243f2f6f6091ab226e3097774e5a7d24fbdb30c9d',
    # 'test': '74416c6ee8f41b1086f0e0e3c5289ac6df5a641100df48e8b583411a55de891f'
    'test': '39f851d36988b6789700be28c5a5c3e42d84b1aeec06e9d6b15144b12bd44a94',
}
_FEDJAX_SQLITE_NUM_BYTES = {'train': 195350528, 'test': 39112704}
...
def _parse_tf_examples(vs: List[bytes]) -> client_datasets.Examples:
  ...
  tf_examples['image'] = tf.cast(tf_examples['image'], dtype=tf.float32)
...
def preprocess_client(
  ...
  del client_id
  return {'x': examples['image'].astype(np.float32), 'y': examples['label'].astype(np.int32)}
